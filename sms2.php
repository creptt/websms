...
<p>
The carrier for the mobile phone the message is being sent to.<br>
<select style="width:100%" name="carrier">
...
<p>
The above fields are required to obtain the SMS address you can copy. If you wish to also send an SMS message, fill in the following fields.
</p>
<p>
The "From:" email address for the SMS.<br>
<input type="text" style="width:100%;" name="from">
</p>
<p>
The message to be sent (remember to keep it short).<br>
<textarea style="width:100%; height:.75in;" name="message"></textarea>
</p>
<p>
